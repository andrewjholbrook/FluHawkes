...
saveRDS(post_prob_child[order(df2$X1),],file = "output/post_processed/naive_h1n1_probs_se.rds")
...
saveRDS(post_prob_child[order(df2$X1),],file = "output/post_processed/naive_h3n2_probs_se.rds")
...
saveRDS(post_prob_child[order(df2$X1),],file = "output/post_processed/naive_vic_probs_se.rds")
...
saveRDS(post_prob_child[order(df2$X1),],file = "output/post_processed/naive_yam_probs_se.rds")
