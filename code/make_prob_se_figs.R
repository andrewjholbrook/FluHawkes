...
h1n1 <- readRDS(file = "output/post_processed/naive_h1n1_probs_se.rds")
h3n2 <- readRDS(file = "output/post_processed/naive_h3n2_probs_se.rds")
yam <- readRDS(file = "output/post_processed/naive_yam_probs_se.rds")
vic <- readRDS(file = "output/post_processed/naive_vic_probs_se.rds")
h1n1[h1n1==100] <- NA
h3n2[h3n2==100] <- NA
yam[yam==100] <- NA
vic[vic==100] <- NA
