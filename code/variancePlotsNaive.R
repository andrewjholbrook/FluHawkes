...
# se weights fig
h1n1 <- readRDS("output/mcmc_samples_naive/naive_h1n1_thinned.rds")
h1n1 <- h1n1[5,] / (h1n1[5,] + h1n1[6,])
h3n2 <- readRDS("output/mcmc_samples_naive/naive_h3n2_thinned.rds")
h3n2 <- h3n2[5,] / (h3n2[5,] + h3n2[6,])
yam <- readRDS("output/mcmc_samples_naive/naive_yam_thinned.rds")
yam <- yam[5,] / (yam[5,] + yam[6,])
vic <- readRDS("output/mcmc_samples_naive/naive_vic_thinned.rds")
